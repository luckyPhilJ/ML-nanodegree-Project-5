...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # Restrict number of dealines to integers of max_deadline and below to cap number of states and only impose 'urgency'
        # when dealine is near
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, epsilon = 1.0, alpha = 0.006007875)
    # alpha for about 500 training trials where epsilon = 1 & tol = 0.05
    # exp: 0.006007875
    # cos: 0.003041558
    # lin: 0.002
